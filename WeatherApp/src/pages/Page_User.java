...
public class Page_User extends Page {
	...
	public Page_User(MainDrive main, String title, String bgPath, boolean showFlag) {
		...
		la_login=new ImageLabel(main.resDir+"./button/upload.png", 330, 50);
	...
	public void loginCheck() {
		...
		try {
			...
			main.connectionManager.closeDB(pstmt, rs);
		}
	}
	...
	public void showMyInfo(String id, String name) {
		...
		la_weather=new ImageLabel(main.resDir+"./button/upload.png", 150, 150);
		la_diary=new ImageLabel(main.resDir+"./button/upload.png", 150, 150);
		la_todolist=new ImageLabel(main.resDir+"./button/upload.png", 150, 150);
		la_store=new ImageLabel(main.resDir+"./button/upload.png", 150, 150);
		...
		la_weather.shortCuts(2);
		la_diary.shortCuts(0);
		la_todolist.shortCuts(1);
		la_store.shortCuts(4);
	}
}